================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Shogi55GUI プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Shogi55GUI には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Shogi55GUI アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Shogi55GUI.h
   ...
   CShogi55GUIApp アプリケーション クラスを宣言します。

Shogi55GUI.cpp
   これは、アプリケーション クラス CShogi55GUIApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Shogi55GUI.ico
   ...
   アイコンはメイン リソース ファイル Shogi55GUI.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、Shogi55GUI.rc ファイル内
...
Shogi55GUIDoc.h, Shogi55GUIDoc.cpp - ドキュメント
   これらのファイルは CShogi55GUIDoc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CShogi55GUIDoc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

Shogi55GUIView.h, Shogi55GUIView.cpp - ドキュメントのビュー
   これらのファイルは CShogi55GUIView クラスを含みます。
   CShogi55GUIView オブジェクトは CShogi55GUIDoc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   Shogi55GUI.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
